...
test "custom" {
    ...
    try checkExecuteFollowsParent(pkb, api.parent, &result_buffer_stream, .NONE, 6, null, .NONE, 7, null, 1);
    try checkExecuteFollowsParent(pkb, api.parent, &result_buffer_stream, .NONE, 6, null, .NONE, 10, null, 1);
}
